...
/**
     ...
     */
fun assert(condition: Boolean = definedExternally, vararg data: Any?): Unit
/**
...
/**
     ...
     */
fun table(tabularData: Any? = definedExternally, properties: js.array.ReadonlyArray<String> = definedExternally): Unit
/**
